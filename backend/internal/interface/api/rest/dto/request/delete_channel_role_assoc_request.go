...
func (r *DeleteGuildRoleChannelAssocRequest) ToDeleteGuildRoleChannelAssociationCommand(requestorID string) (*command.DeleteGuildRoleChannelAssociationCommand, error) {
