...
type GuildRoleService interface {
	...
	Create(ctx context.Context, createCommand *command.CreateGuildRoleCommand) (*command.CreateGuildRoleCommandResult, error)
	Update(ctx context.Context, updateCommand *command.UpdateGuildRoleCommand) (*command.UpdateGuildRoleCommandResult, error)
