...
func NewVoiceStateUserResultFromUserGuildMember(user *entities.User, guildmember *entities.GuildMember) *common.VoiceStateUserResult {
	if user == nil {
		return nil
	}
...
func NewVoiceStateUserProtoResultFromUserGuildMember(user *entities.User, guildmember *entities.GuildMember) *pb.User {
	if user == nil {
		return nil
	}
