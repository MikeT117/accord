...
channels_cte AS (
	SELECT c.id, c.name, c.topic, c.channel_type, c.parent_role_sync, c.parent_id, c.creator_id, c.guild_id, c.created_at, c.updated_at
	FROM channels c
...
type GetWebsocketInitialisationPayloadRow struct {
	...
	PrivateChannels    json.RawMessage
	VoiceChannelStates json.RawMessage
}
