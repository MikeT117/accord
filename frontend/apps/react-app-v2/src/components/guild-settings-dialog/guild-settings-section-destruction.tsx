...
export function GuildSettingsDestructionSection({ guildId, name, onClose }: GuildSettingsDestructionSectionProps) {
    const { mutate: deleteGuild } = useDeleteGuildMutation({ onSuccess: onClose });
