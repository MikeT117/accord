...
import { useGuildTextChannelWithPermissions } from "@/lib/zustand/stores/guild-store";
...
function RouteComponent() {
    ...
    const user = useUser();
    const { channel, permissions } = useGuildTextChannelWithPermissions(guildId, channelId);
