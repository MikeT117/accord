...
const buttonStyles = cva(
    'flex items-center rounded-md focus:outline-none cursor-pointer font-medium text-sm disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap font shrink-0',
    {
        variants: {
            intent: {
