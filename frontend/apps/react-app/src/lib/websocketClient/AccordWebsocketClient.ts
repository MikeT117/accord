...
type WebSocketClientEmitPayload<T = any, R = unknown> = {
    id?: string;
...
type WebsocketClientOptions = {
    ...
    debug?: boolean;
    reconnect?: boolean;
    identifyPayload: () => { accesstoken: string; refreshtoken: string } & any;
...
class AccordWebsocketClient {
    ...
    #_identifyPayload: () => { accesstoken: string; refreshtoken: string } & any;
    ...
    constructor({
        ...
        this.#_identifyPayload = identifyPayload;
        this.#_connect();
    }
    ...
    emit<T = any, R = unknown>({ callback, ...payload }: WebSocketClientEmitPayload<T, R>) {
        this.#_logEvents(
            'Event',
            'Emit',
