import { NoSymbolIcon, UserGroupIcon as UserGroupIconOutline } from '@heroicons/react/24/outline';
      ...
      <MainSidebarContentLayout>
        <ul className='mt-2 mb-6 space-y-1 px-2'>
          ...
          <ListItem
            ...
            isActionable
          >
            <UserGroupIconOutline className='h-5 w-5' />
        ...
        <div className='mb-2 flex items-center px-2 '>
          <span className='select-none text-xs font-semibold text-gray-11'>Direct Mesages</span>
        </div>
