...
const { setSection, toggleOpen } = currentUserSettingsStore;

export const UserSettingsContent = () => {
  const section = useCurrentUserSettingsStore(useCallback((s) => s.section, []));
...
export const UserSettings = () => {
  const isOpen = useCurrentUserSettingsStore(useCallback((s) => s.isOpen, []));
  return (
